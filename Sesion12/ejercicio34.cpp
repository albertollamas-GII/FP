...
int main()
{
   ...
   // Llamar al método para calcular      indice_mas_conectada"
   indice_mas_conectada = mapa.CiudadMejorConectada();
   cout << "La ciudad con más conexiones directas es la ciudad: "
        <<      indice_mas_conectada;

   //-----------------------------------------------------------
   // Mejor escala entre origen y destino
   // Llamar al método para calcular "escala"
