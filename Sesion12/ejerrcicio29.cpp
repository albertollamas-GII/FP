...
// El algoritmo para ver si s un pal�ndromo e invertir un vector
// se encuentra en el siguiente enlace 
// (trabaja directamente con un vector definido en el main)
// https://decsai.ugr.es/jccubero/FP/III_PalindromoInvierte
...
int main(){
   ...
   if (es_palindromo)
      ...
      cout << "\nNo es palindromo" 
           << "\nCadena invertida: " << secuencia.ToString() << endl;
