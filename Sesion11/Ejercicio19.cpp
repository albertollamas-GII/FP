...
int main(){
   ...
   parcela.SetCoordenada(esquina_x, esquina_y);
   parcela.SetLado(long_parcela);

   cin >> esquina_x;
   cin >> esquina_y;
   cin >> long_parcela;

   otra_parcela.SetCoordenada(esquina_x, esquina_y);
   otra_parcela.SetLado(long_parcela);
